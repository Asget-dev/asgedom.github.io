...
describe("maxOfThree", function () {
    ...
    it("tests -1 -2 -3", function () {
        assert.strictEqual(fns.maxOfThree(-1, -2, -3), -1);
    });
});
...
describe("sum and multiply", function () {
    it("tests multiply 1 2 3", function () {
